...
import img3 from "../../public/nano/close-up-car-care-process_23-2149193578.jpg";
import img2 from "../../public/nano/car-wash-detailing-station_1303-22306.jpg";
import img from "../../public/nano/car-detailing-polishing-series-worker-black-gloves-with-microfiber-cloth_981948-26557.jpg";
        ...
        <div className="space-y-8 bg-zinc-900/60 p-8 rounded-3xl border border-[#cd7f32]/30 shadow-lg">
          ...
          <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
            {[
             " افضل حماية نانو",
             "ضمان لمدة سنتين",
             " طبقة واحدة مجانية بعد كل 6 أشهر",
             " غسيل السيارات مجانا",
